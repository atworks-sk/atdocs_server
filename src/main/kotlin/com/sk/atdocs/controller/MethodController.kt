...
class MethodController (
    ...
    fun searchList(reqDto: SearchListReqDto, pageable: Pageable): ResponseEntity<Page<MethodListDto>>{
    ...
    fun searchDetail(@PathVariable id : Long) : ResponseEntity<MethodDto>{
